package ro.ubbcluj.map.socialnetworkgui.repository.database.in_memory;
...
import ro.ubbcluj.map.socialnetworkgui.repository.database.AbstractDBRepository;

import java.sql.*;
import java.sql.Date;
import java.util.*;

public class UserDBInMemoryRepository extends AbstractDBRepository<Long, User> {

    public UserDBInMemoryRepository(String url, String sqlUsername, String sqlPassword, Validator<User> userValidator) {
